...
# bright colors
THEME[brightblack]="$(tmux_get_opt @tmux-status-line_color_ansi8 "brightblack")"
THEME[brightred]="$(tmux_get_opt @tmux-status-line_color_ansi9 "brightred")"
THEME[brightgreen]="$(tmux_get_opt @tmux-status-line_color_ansi10 "brightgreen")"
THEME[brightyellow]="$(tmux_get_opt @tmux-status-line_color_ansi11 "brightyellow")"
THEME[brightblue]="$(tmux_get_opt @tmux-status-line_color_ansi12 "brightblue")"
THEME[brightmagenta]="$(tmux_get_opt @tmux-status-line_color_ansi13 "brightmagenta")"
THEME[brightcyan]="$(tmux_get_opt @tmux-status-line_color_ansi14 "brightcyan")"
THEME[brightwhite]="$(tmux_get_opt @tmux-status-line_color_ansi15 "brightwhite")"
# git colors
