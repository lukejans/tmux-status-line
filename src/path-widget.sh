...
SHOW_PATH=$(tmux show-option -gv @tmux-status-line_show_path 2>/dev/null)
PATH_FORMAT=$(tmux show-option -gv @tmux-status-line_path_format 2>/dev/null) # full | relative
